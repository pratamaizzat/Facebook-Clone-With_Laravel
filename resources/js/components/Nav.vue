<template>
  <div class="bg-white h-Nav flex items-center px-4 shadow-sm border-b border-gray-400">
    <div class="w-1/3">
      <div class="flex items-center">
        ...
        <div class="ml-2 relative">
          <div class="absolute">
            <svg viewBox="0 0 24 24" class="fill-current text-gray-600 w-5 h-5 mt-2 ml-2">
              <path
                fill-rule="evenodd"
          ...
          <input
            type="text"
            name="search"
            class="w-64 h-8 rounded-full border-2 bg-gray-100 text-sm placeholder-gray-800 focus:outline-none focus:shadow-outline tracking-wide px-8 hover:bg-gray-200"
    ...
    <div class="w-1/3 flex justify-center items-center h-full">
      <router-link
        to="/"
        class="px-6 border-b-2 border-white h-full flex items-center hover:border-blue-600 focus:outline-none"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          class="text-blue_custom fill-current w-8 h-8"
        >
          <path
      ...
      <router-link
        to="/"
        class="px-6 border-b-2 border-white h-full flex items-center focus:outline-none"
      >
        <img
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          class="fill-current text-blue_custom w-8 h-8"
        >
          <path
    ...
    <div class="w-1/3 flex justify-end">
      <div
        class="h-8 w-8 bg-gray-200 bg-cover rounded-full overflow-hidden flex justify-center items-center"
      >
